...
const initDb = (): void => {
  ...
  db.exec(`DROP TABLE IF EXISTS plant_photos;`);
  db.exec(`DROP TABLE IF EXISTS personal_plants;`);
  db.exec(`DROP TABLE IF EXISTS care_logs;`);
  db.exec(`DROP TABLE IF EXISTS care_schedules;`);
  db.exec(`DROP TABLE IF EXISTS plant_inventory;`);
  db.exec(`DROP TABLE IF EXISTS plant_propagation;`);
  db.exec(`DROP TABLE IF EXISTS market_price;`);
  db.exec(`DROP TABLE IF EXISTS plants;`);
  db.exec(`DROP TABLE IF EXISTS plant_species;`);
  db.exec(`DROP TABLE IF EXISTS plant_genus;`);
  db.exec(`DROP TABLE IF EXISTS plant_family;`);
  db.exec(`DROP TABLE IF EXISTS users;`);
  db.exec(`DROP TABLE IF EXISTS care_tips;`);
  ...
  db.exec(`CREATE TABLE plant_family (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
  ...
  db.exec(`CREATE TABLE plant_genus (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE,
  ...
  db.exec(`CREATE TABLE plant_species (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE,
  ...
  db.exec(`CREATE TABLE market_price (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
  ...
  db.exec(`CREATE TABLE plant_propagation (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
    prop_type INTEGER,
    seed_source TEXT,
  ...
  db.exec(`CREATE TABLE plant_inventory (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
    quantity INTEGER,
    plant_age INTEGER,
  ...
  db.exec(`CREATE TABLE care_schedules (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
  ...
  db.exec(`CREATE TABLE care_logs (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
  ...
  db.exec(`CREATE TABLE care_tips (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
  ...
  db.exec(`CREATE TABLE personal_plants (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
    count INTEGER,
    zero_reason TEXT,
  ...
  db.exec(`CREATE TABLE plant_photos (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    plant_id INTEGER NOT NULL,
