<template>
  <div>
    <v-btn color="primary" variant="outlined" prepend-icon="mdi-arrow-left" to="/market-prices" class="mb-6">
      Back to Price List
    </v-btn>
    ...
    <v-row>
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <div v-if="priceDifference !== null" class="d-flex align-center">
              <v-icon :color="priceDifference >= 0 ? 'success' : 'error'" class="me-2">
        ...
        <v-card class="mt-4">
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="6">
                <v-text-field v-model="newPrice.dateChecked" label="Date" type="date" required />
              </v-col>
            </v-row>
            <v-btn color="primary" block :loading="saving" :disabled="!newPrice.price" @click="addNewPrice">
              Add Price Record
            </v-btn>
          </v-card-text>
        </v-card>
      ...
      <v-col cols="12" md="6">
        <v-card>
          ...
          <v-card-text v-else>
            <div id="price-chart" class="pa-2" style="height: 300px" />
          </v-card-text>
        </v-card>
        ...
        <v-card class="mt-4">
          ...
          <v-data-table
            ...
            <template #item.actions="{item}">
              <v-btn color="error" variant="text" size="small" icon @click="confirmDeletePrice(item)">
    ...
    <v-dialog v-model="deleteDialog" max-width="400px">
      <v-card>
        ...
        <v-card-actions>
          ...
          <v-btn color="error" :loading="deleting" @click="deletePrice"> Delete </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
